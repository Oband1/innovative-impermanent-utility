;; impermanent-utility
;; A decentralized platform for transformative task management and dynamic reputation tracking
;; This contract enables users to create adaptive tasks, participate in community challenges,
;; and build a reputation-driven ecosystem of personal and collaborative growth.

;; Error codes
(define-constant ERR-NOT-AUTHORIZED (err u200))
(define-constant ERR-TASK-NOT-FOUND (err u201))
(define-constant ERR-INVALID-CADENCE (err u202))
(define-constant ERR-INVALID-COMPLEXITY (err u203))
(define-constant ERR-ALREADY-COMPLETED-TODAY (err u204))
(define-constant ERR-TASK-NOT-ACTIVE (err u205))
(define-constant ERR-MISSION-NOT-FOUND (err u206))
(define-constant ERR-ALREADY-JOINED-MISSION (err u207))
(define-constant ERR-NOT-MISSION-MEMBER (err u208))
(define-constant ERR-BLUEPRINT-NOT-FOUND (err u209))
(define-constant ERR-INSUFFICIENT-INFLUENCE (err u210))
(define-constant ERR-BLUEPRINT-NOT-TRADABLE (err u211))
